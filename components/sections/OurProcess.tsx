...
export const OurProcess: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-brand-blue/30 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute top-1/3 right-1/4 w-[400px] h-[400px] bg-brand-orange/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 w-full relative z-10">
        ...
        <div className="relative">
          ...
          <div
            className="hidden lg:block absolute top-7 left-[12%] right-[12%] h-[1.5px] border-t-2 border-dashed border-gray-700/60 z-0 pointer-events-none"
            aria-hidden="true"
          />
              ...
              return (
                ...
                >
                  ...
                  <div className="relative mb-6 flex items-center justify-center">
                    <div className="w-14 h-14 rounded-full bg-[#0B1320] border-2 border-[#13243B] group-hover:border-brand-orange text-brand-orange flex items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-brand-glow/30">
                      <Icon className="w-6 h-6" />
                    </div>
                    {/* Small step number tag */}
                    <span className="absolute -top-2 -right-2 px-1.5 py-0.5 rounded-full bg-[#13243B] border border-brand-orange/40 text-[10px] font-bold text-brand-orange tracking-wider">
                      {step.step}
                    </span>
                  </div>

                  {/* Step Title */}
                  <h3 className="font-playfair text-xl sm:text-2xl font-bold text-white mb-2.5 group-hover:text-brand-orange transition-colors">
                    {step.title}
                  </h3>

                  {/* Step Description */}
                  <p className="font-inter text-xs sm:text-sm text-gray-300 leading-relaxed max-w-[240px]">
                    {step.description}
                  </p>
                </motion.div>
              );
